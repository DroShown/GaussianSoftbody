...
namespace GaussianSplatting.Runtime
{
    ...
    class GaussianSplatRenderSystem
    {
        ...
        //选择当前相机的GS对象，将其添加到m_ActiveSplats列表中
        ...
        public Material SortAndRenderSplats(Camera cam, CommandBuffer cmb)
        {
            ...
            {
                // gs: GaussianSplatRenderer, mpb: MaterialPropertyBlock
                var gs = kvp.Item1;
        ...
        // 事件处理函数，用于在相机渲染之前进行GS对象的渲染，包括排序和绘制，最后合成，将结果渲染到相机的目标上，这个函数会在每帧调用，用于渲染所有的GS对象。
    ...
    public class GaussianSplatRenderer : MonoBehaviour
    {
        ...
        [Range(0.001f, 1.0f)] [Tooltip("Additional scaling factor for the splats")]
        ...
        internal int m_SplatCount; // initially same as asset splat count, but editing can change this
        GraphicsBuffer m_GpuSortDistances;
        internal GraphicsBuffer m_GpuSortKeys;
        public GraphicsBuffer m_GpuPosData;
        public GraphicsBuffer m_GpuRestPosData;
        ...
        internal static class Props
        {
            ...
            public static readonly int SplatRestPos = Shader.PropertyToID("_SplatRestPos");
            ...
            public static readonly int PosDelta = Shader.PropertyToID("_PosDelta");
        ...
        void CreateResourcesForAsset()
        {
            ...
            m_GpuRestPosData = new GraphicsBuffer(GraphicsBuffer.Target.Raw | GraphicsBuffer.Target.CopySource, (int) (asset.posData.dataSize / 4), 4) { name = "GaussianRestPosData" };
            m_GpuRestPosData.SetData(asset.posData.GetData<uint>());
        ...
        internal void SetAssetDataOnCS(CommandBuffer cmb, KernelIndices kernel)
        {
        ...
        internal void DispatchUtilsAndExecute(CommandBuffer cmb, KernelIndices kernel, int count)
        {
